    ...
    private void frissites() {
        AsyncTask.execute(new Runnable() {
            ...
            public void run() {
                ...
                final ListView betegLista = (ListView)findViewById(R.id.beteg_lista);
                ...
                final ArrayAdapter<Beteg> adapter = new ArrayAdapter<Beteg>(
                        MainActivity.this,
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menu_ujbeteg:
                Intent intent2 = new Intent(this, UjBetegActivity.class);
                startActivity(intent2);

                return true;
            /*
            case R.id.menu_ujszerv:
                Intent intent3 = new Intent(this, UjSzervActivity.class);
